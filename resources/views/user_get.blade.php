...
@section('content')
                                ...
                                <table id="example" class="table table-flush dataTable-table" style="width:100%">
                                    ...
                                    <tr>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" data-sortable="" style="width: 20.977%;">
                                            <a href="#" class="dataTable-sorter">Usuario</a>
                                        </th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" data-sortable="" style="width: 20.977%;">
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" data-sortable="" style="width: 20.977%;">
                                            <a href="#" class="dataTable-sorter">Tienda</a>
                                        </th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" data-sortable="" style="width: 20.977%;">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <div>
                                                            <img src=" {{ (!empty(($user->photo))) ? asset('storage/'.$user->photo) : 'https://www.caribbeangamezone.com/wp-content/uploads/2018/03/avatar-placeholder.png' }}" class="avatar avatar-sm me-3" alt="avatar image">
                                                        </div>
                                                ...
                                                <td>
                                                    <p class="text-sm text-secondary mb-0 roll">{{$user->code_satff}}</p>
                                                </td>
                                                ...
                                                <td>
                                                    <span class="text-secondary text-sm">{{$user->store}}</span>
                                                </td>
    ...
    <script>
        ...
        $("#acept_delete_roll").click(function (){
            ...
            fetch( url+"/delete_user", requestOptions)
